...
//    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        cameraModel = glm::scale(cameraModel,glm::vec3(0.2,0.2,0.2));
        ...
        cameraModel = glm::translate(cameraModel,cameraPosition);

        glm::mat4 projection = glm::perspective(glm::radians(45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
        glm::mat4 view = glm::lookAt(cameraPosition,glm::vec3(0.0f,0.0f,0.0f),glm::vec3(0,1.0,0));
        ...
        boxModel = glm::translate(boxModel,glm::vec3(1.0,1.0,0.0));
        boxModel = glm::rotate(boxModel,glm::radians(45.0f),glm::vec3(1.0,0.0,0.0));
